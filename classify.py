...
loves = loves.sort_values(['count'], ascending=False)[0:280]
...
count_vect = TfidfVectorizer(tokenizer=tokenize, stop_words=sw, strip_accents='ascii', ngram_range=(1, 2), use_idf=True,
                             smooth_idf=True)
...
grid = GridSearchCV(LinearSVC(), param_grid={'C': [0.01, 0.1, 1, 10, 100, 1000]}, cv=10, scoring='f1_micro')
